...
public class Processor {
	...
	public void process() {
		...
		ServiceFactory serviceFactory = new ServiceFactory(useCaseModel.getInteraction(), useCaseModel.getService(),
		...
		new RedisGenerator(serviceFactory.getOperation(OperationInfo.ConcurrencyType.HIGHPRIORITY), globalInfo)
				.generate();

		// todo configpackage, redisdeploy, commonpackage, serverpackage,
		// highprioritypackage, etcpackage 's generate
